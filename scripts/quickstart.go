...
func tokenCacheFile() (string, error) {
	...
	return os.Getenv("GOOGLE_OAUTH_TOKENS"), nil
}
...
func main() {
	...
	config, err := google.ConfigFromJSON(b, youtube.YoutubeUploadScope, youtube.YoutubeForceSslScope, youtube.YoutubepartnerScope)
	if err != nil {
